...
# basename() — возвращает имя файла из абсолютного или относительного пути (последний объект в пути);
# dirname() — возвращает имя (путь) папки, в которой расположен файл (предпоследний объект);
